	 ...
	 */
        ...
        _generateHTML: function(inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                ' title="' + prevText + '">' + (isRTL ? '<span class="ui-icon ui-icon-circle-triangle-e"></span>' : '<span class="ui-icon ui-icon-circle-triangle-w"></span>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+ prevText +'">' + (isRTL ? '<span class="ui-icon ui-icon-circle-triangle-e"></span>' : '<span class="ui-icon ui-icon-circle-triangle-w"></span>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<span class="ui-icon ui-icon-circle-triangle-w"></span>' : '<span class="ui-icon ui-icon-circle-triangle-e"></span>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+ nextText + '">' + (isRTL ? '<span class="ui-icon ui-icon-circle-triangle-w"></span>' : '<span class="ui-icon ui-icon-circle-triangle-e"></span>') + '</a>'));
